...
MPC-lab / учебный проект по конфиденциальным вычислениям.

Реализовал базовые механизмы MPC на Python: арифметику над конечным полем, additive secret sharing, Shamir secret sharing, восстановление секрета через интерполяцию Лагранжа и умножение с использованием Beaver triples. Добавил demo secure aggregation для вычисления суммы без раскрытия входов участников.
